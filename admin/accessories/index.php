...
<body class="loggedin">
    <div class="content">
        ...
        <button type="button" class="close" data-dismiss="alert">
            <a href="./newphoto.php"><i class="fas fa-images"></i>Add New photo</a>
        </button>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center; margin-top:10px; word-break:break-all; width:450px; line-height:100px;">
                                ...
                                <?php else : ?>
                                    <img src="../../photos/empty.png" alt=" <?php echo $row['Photos_name']; ?>" width="100px" height="100px" style="border:1px solid #333333;">
                                <?php endif; ?>
                            </td>
